...
namespace eastl
{
	...
	public:
		...
		allocator_forge& operator=(const allocator_forge&)
		{
			return *this;
		}

		bool operator==(const allocator_forge&)
		{
			return true;
		}
	...
	inline bool operator==(const allocator_forge&, const allocator_forge&)
	{
		return true;
	}
	inline bool operator!=(const allocator_forge&, const allocator_forge&)
